...
channel_secret = "72c5fd0550552aa6e9030717e1643614"
channel_access_token = "zTBP7VI2c6LEmiR+ge24W24WeOA+F4AxNDsZcFQS31QPoN44NWeVh8CBSLC8ImLvbkYUvoBp9uJiyNX1C3Xga0yCo3rIIgwDUGuwVhJy0+IM743Zeb8yTIw9NaNMBYgow0IFeC3HvqtPey2cYORkbwdB04t89/1O/w1cDnyilFU="
...
def handle_text_message(event):
    ...
    if ("!menu" in text) or ("menu" in textlow):
        carousel_template = CarouselTemplate(columns=[
            CarouselColumn(text='Konsultasi dengan admin kami', title='Konsultasi', thumbnail_image_url='https://cdn2.tstatic.net/jateng/foto/bank/images/tugu-muda-semarang-ok.jpg', actions=[
                URIAction(
                        label='Line@',
                        uri='https://line.me/R/ti/p/%40nut4837y'),
            ]),
            CarouselColumn(text='Informasi mengenai Alfalink', title='Info',thumbnail_image_url='https://cdn2.tstatic.net/jateng/foto/bank/images/tugu-muda-semarang-ok.jpg', actions=[
                MessageAction(
                        label='Detail', text='Info'),
            ])
        ])
        template_message = TemplateSendMessage(
            alt_text='Info', template=carousel_template)
        ...
        carousel_template = CarouselTemplate(columns=[
            CarouselColumn(text='Information About Alfalink', title='Informasi Alfalink', thumbnail_image_url='https://cdn2.tstatic.net/jateng/foto/bank/images/tugu-muda-semarang-ok.jpg', actions=[
                URIAction(
                        label='About Us',
        ...
        template_message = TemplateSendMessage(
            alt_text='Menu', template=carousel_template)
        line_bot_api.reply_message(
            event.reply_token, [
                TextSendMessage(
                    text="Info Alfalink"),
...
def handle_follow(event):
    ...
    try:
        ...
        user_name = "someone"
    confirm_template = ConfirmTemplate(text='Butuh Bantuan?', actions=[
        MessageAction(label='Ya', text='Menu'),
        MessageAction(label='Tidak', text='tidak'),
    ])
    template_message = TemplateSendMessage(
        alt_text='Bantuan', template=confirm_template)
    line_bot_api.reply_message(
        event.reply_token, [
            TextSendMessage(
                text="Hai,"+user_name+ "\nSelamat datang di Alfalink Bot"),
            template_message
    ]) 
